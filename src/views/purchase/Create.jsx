...
export default function CreatePurchase() {
  ...
  // Form state - Updated to match sales structure
  ...
  // Supplier/Dealer type
  const [supplierType, setSupplierType] = useState('SUPPLIER');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        // router.push(`/api/purchase-invoice-api/${data.data.purchase_id}`);
      } else {
        ...
        <Grid item xs={12}>
          <form onSubmit={handleSubmit}>
            <Grid container spacing={3}>
              ...
              {/* Purchase Items Table - Same as Sales */}
              <Grid item xs={12}>
                                  ...
                                  <TableCell>
                                    <TextField
                                      ...
                                      onChange={(e) => {
                                        ...
                                        // remove leading zeros (except single 0 while typing)
