    ...
    <div className={`min-h-screen p-6 ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-50'}`}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <Link href="/goods-catalog/create" className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-md flex items-center">
                  ...
                  <tr key={item.goodsId} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-3">
                        <Link href={`/goods-catalog/view/${item.goodsId}`} className={`p-2 rounded-lg ${theme === 'dark' ? 'text-green-400 hover:bg-gray-700' : 'text-green-600 hover:bg-green-50'}`} title="View">
                          <Eye className="w-4 h-4" />
                        </Link>
                        <Link href={`/goods-catalog/edit/${item.goodsId}`} className="text-blue-600"><Edit className="w-5 h-5" /></Link>
                        <button onClick={() => handleDelete(item.goodsId)} className="text-red-600"><Trash2 className="w-5 h-5" /></button>
                      </div>
                    </td>
                  </tr>
                ))}
