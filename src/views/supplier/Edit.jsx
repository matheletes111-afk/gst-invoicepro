...
export default function EditSupplier({ id }) {
  ...
  const loadSupplier = async () => {
    ...
    try {
      ...
      if (data.success && data.supplier) {
        ...
        setFormData({
          businessLicenseNo: s.businessLicenseNo || "",
          supplierName: s.supplierName || "",
          taxpayerRegStatus: s.taxpayerRegStatus || "NO",
          taxpayerRegNo: s.taxpayerRegNo || "",
          taxpayerRegRegion: s.taxpayerRegRegion || "",
          dzongkhagId: s.dzongkhagId?.toString() || "",
          gewogId: s.gewogId?.toString() || "",
          villageId: s.villageId?.toString() || "",
          location: s.location || "",
