...
export default function SalesTransactionsReport() {
  ...
  const fetchReportData = async (resetFilters = false, page = currentPage, limit = itemsPerPage) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        if (statusFilterValue !== 'ALL') filters.push(`Status: ${getStatusText(statusFilterValue)}`);
  ...
  const exportToCSV = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `sales-register-report-${new Date().toISOString().split('T')[0]}.csv`;
  ...
  const exportToPDF = async () => {
    ...
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = `sales-register-report-${new Date().toISOString().split('T')[0]}.pdf`;
      document.body.appendChild(a);
      a.click();
      window.URL.revokeObjectURL(url);
      document.body.removeChild(a);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Sales Transactions Report</h1>
          <p className="text-gray-600">Summary of all sales transactions for financial and tax reconciliation</p>
        </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {formatCurrency(summary?.total_exempt)}
                </p>
              </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {formatCurrency(summary?.total_gst)}
                </p>
              </div>
        ...
        <div className="bg-white rounded-lg shadow mb-6 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search by invoice no, customer name, TPN..."
                value={searchQuery}
            ...
            <div>
              ...
              >
                ...
                <option value="IP">Submitted</option>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="text-sm text-gray-600">
              <p>Monthly/Quarterly report for financial reconciliation</p>
            </div>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {loading ? (
                  ...
                  reportData.map((invoice, index) => {
                    ...
                    return (
                      <tr key={invoice.sales_id || index} className="hover:bg-gray-50">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm font-medium text-gray-900">
                            {invoice.sales_invoice_no || `INV-${invoice.sales_id}`}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <div className="flex items-center">
                            <div className="h-8 w-8 rounded-full bg-blue-100 flex items-center justify-center mr-3">
                              <span className="text-blue-600 font-semibold">
                                {invoice.customer_name?.charAt(0)?.toUpperCase() || 'C'}
                              </span>
                            </div>
                            <div>
                              <div className="text-sm font-medium text-gray-900">
                              ...
                              <div className="text-xs text-gray-500">
                                {invoice.payment_mode ? invoice.payment_mode.replace(/_/g, ' ') : 'N/A'}
                              </div>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-gray-100 text-gray-800">
                            {invoice.customer_tpn || invoice.customer?.tpn || '-'}
                          </span>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">
                          ...
                          <div className="text-xs text-gray-500">
                            Exempt: {formatCurrency(invoice.exempt_amount)}
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">
        ...
        {!loading && reportData.length > 0 && (
          <div className="mt-4 text-sm text-gray-500">
            ...
            <p>Page {currentPage} of {totalPages} • 
              ...
              Taxable: {formatCurrency(summary?.total_taxable)} • 
              GST: {formatCurrency(summary?.total_gst)} • 
              Total: {formatCurrency(summary?.total_revenue)}
            </p>
