...
export async function GET(req) {
    try {
        ...
        const sortBy = searchParams.get("sortBy") || "dealerId";
        ...
        const total = await prisma.dealerMaster.count({ where });

        const data = await prisma.dealerMaster.findMany({
            where,
            skip,
            take: limit,
...
export async function DELETE(req) {
    try {
        ...
        const exists = await prisma.dealerMaster.findUnique({
        ...
        await prisma.dealerMaster.update({
            where: { dealerId: parseInt(dealerId) },
            data: { status: "D" },
        });
