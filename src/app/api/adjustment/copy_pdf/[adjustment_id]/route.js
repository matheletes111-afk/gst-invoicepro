...
export async function GET(req, { params }) {
  try {
    ...
    // Create copy tracking record
    const copyTracking = await prisma.copyTrackingAdjustment.create({
      data: {
    ...
    console.log("Copy tracking record created:", copyTracking);
    ...
    const html = generateAdjustmentNoteHTML({
      ...
      issueDate: issueDate,
      isCopy: true,
      copyTrackingId: copyTracking.copy_tracking_adjustment_id
    });
    ...
    return new NextResponse(html, {
      ...
      headers: {
        ...
        'Content-Disposition': `inline; filename="adjustment-copy-${adjustment.adjustment_note_no || adjustmentId}.html"`
      }
    });
...
<body>
  ...
  <div class="invoice-container" id="adjustment-content">
    ...
    <!-- Adjustment Note No + Date + Issue Date -->
    <div class="top-row">
      <div>
  ...
  <script>
    ...
    const qrText = JSON.stringify({
      ...
      issueDate: '${formatDateForQR(issueDate)}',
      adjustmentNoteType: "Copy",
    ...
    async function downloadPDF() {
      ...
      try {
        ...
        // Save the PDF with "copy" in the filename
        pdf.save('adjustment-copy-${adjustment.adjustment_note_no || adjustmentId}.pdf');
