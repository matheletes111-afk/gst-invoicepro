...
<head>
  ...
  <title> Invoice - ${sales.sales_invoice_no || 'INV/2025/001'}</title>
...
<body>
  ...
  <div class="invoice-container" id="invoice-content">
    <h1 style="border-top: 2px solid black; border-bottom: 2px solid black; line-height: 57px;"> Invoice</h1>
...
const qrText = [
  ...
  try {
    ...
    try {
      ...
      // Keep QR modules crisp when rasterizing
    ...
    async function downloadPDF() {
      ...
      try {
        ...
        // JPEG at higher quality avoids hazy/bluish artifacts while staying small
        ...
        // Save PDF
        const filename = 'invoice-copy-' + ('${sales.sales_invoice_no || salesId}') + '.pdf';
        pdf.save(filename);
