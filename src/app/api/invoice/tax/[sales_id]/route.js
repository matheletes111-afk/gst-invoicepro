...
<body>
  ...
  <div class="invoice-container" id="invoice-content">
    <h1 style="border-top: 2px solid black; border-bottom: 2px solid black; line-height: 57px;">Tax Invoice</h1>
    ...
    <div class="payment">
      Payment Mode: ${sales.payment_mode
  ...
  try {
    ...
    async function downloadPDF() {
      ...
      try {
        ...
        // Save PDF
        const filename = 'invoice-tax-' + ('${sales.sales_invoice_no || salesId}') + '.pdf';
        pdf.save(filename);
